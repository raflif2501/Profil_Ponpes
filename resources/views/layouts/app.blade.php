...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('admin') }}/dist/img/logo.png" alt="PONPES MATHALI'UL ANWAR"
                height="60" width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('home') }}" class="brand-link">
                <img src="{{ asset('admin') }}/dist/img/logo.png" alt="PONPES MATHALI'UL ANWAR"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">MATHALI'UL ANWAR</span>
            </a>
        ...
        <footer class="main-footer fixed-bottom">
            <strong>Pondok Pesantren Mathali'ul Anwar</strong>
